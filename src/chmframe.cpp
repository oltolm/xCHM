...
<body>
    <table border=0>
        <tr>
            <td align="left">
                <img src="memory:logo.xpm">
            </td>
            <td align="left">Hello, and welcome to <B>xCHM</B>, the UNIX CHM viewer.
                ...
                <a href="http://www.wxwidgets.org">wxWidgets</a>.<br><br>
            </td>
        </tr>
    </table>
    ...
    <br><br>Tips:<br>
    <ul>
        <li>The global search is an 'AND' search, i.e. searching for 'word1 word2'
        ...
        <li>Allowing partial matches will find pages that contain words that only start with the typed strings,
            ...
            'The answer is 42.'.</li>
        <li>Right clicking on the displayed page brings out a popup menu with
            common options.</li>
    </ul><br><br>Ctrl-'c' is copy, Ctrl-'f' is find in page, Ctrl-'=' is zoom-in,
    Ctrl-'-' is zoom-out.<br><br>Enjoy.
</body>
